          ...
          <div className="about-item about-item-blue rounded p-4">
            <div className='h-100 position-relative'>
              <div className='d-flex flex-column justify-content-center h-100'>
                <h3 className='text-light text-center'>Rosa Parks</h3>
                <p className='text-light text-center mb-0'>Memories of our lives, of our works and our deeds will continue in others.</p>
              </div>
