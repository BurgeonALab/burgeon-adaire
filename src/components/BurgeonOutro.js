      ...
      <Fragment>
        <section id="acknowledgment" className='outro-container container-fluid py-3 d-flex'>
          ...
          <div className='outro-container-background'>
            <img className='outro-cover' alt="Gratitude Photo" src="https://images.burgeonadaire.com/outro-cover.webp"></img>
          </div>
          ...
          <div className='outro-box outro-mobile col-md-12 d-flex align-items-end justify-content-end flex-column'>
            ...
            <p className='outro-text-mobile h4 mt-4 mb-0 text-end'>
              <a className='outro-link-mobile link-light text-decoration-none pointer-events-auto' href='https://wellcomecollection.org/works/w9kd2eed/images?id=uf2897g8' target='_blank' rel='noopener'>
